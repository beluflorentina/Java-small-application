...
background: #D9D9D9;
  ...
  <body bgcolor="#2A4E2D">
      ...
      <div><button class="button" onclick="location.href='SignUpUser.jsp';"><label class="User">User</label></button></div>
      <div><button class="button2"><label class="Admin"">Admin</label></button></div>
       <div class="texts">
